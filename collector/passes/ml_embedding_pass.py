...
class EnhancedMLEmbeddingPass:
    ...
    def __init__(self, advanced_parser: AdvancedTitleParser, fuzzy_matcher: FuzzyMatcher, db_manager=None):
    ...
    def _find_best_semantic_match(
        self, candidate_embeddings: Dict[str, np.ndarray], candidates: List[str], 
        match_type: str
    ...
    async def _hybrid_matching(
        ...
        better_result = fuzzy_result if fuzzy_result.confidence > semantic_result.confidence else semantic_result
    ...
    def get_statistics(self) -> Dict:
        ...
        return {
            ...
            "entities_with_embeddings": sum(
                1 for candidate in list(self.artist_candidates.values()) + list(self.song_candidates.values())
