...
class DiscogsMonitor:
    ...
    def record_api_call(self, success: bool, response_time_ms: float, 
                       timeout: bool = False, rate_limited: bool = False):
    ...
    def record_search_attempt(self, success: bool, confidence: float = 0.0, 
                            fallback: bool = False):
    ...
    def record_data_quality(self, has_year: bool = False, has_genres: bool = False,
    ...
    def get_current_metrics(self) -> Dict:
        ...
        return {
            ...
            "timestamps": {
                ...
                "last_api_call": self.metrics.last_api_call.isoformat() if self.metrics.last_api_call else None,
    ...
    def log_metrics_summary(self):
        ...
        logger.info(f"API Calls: {metrics['api_metrics']['total_calls']} "
                   f"(Success: {metrics['api_metrics']['success_rate']:.1%})")
        logger.info(f"Searches: {metrics['search_metrics']['total_searches']} "
