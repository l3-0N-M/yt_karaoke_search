...
def analyze_database(db_path):
    ...
    print(
        f"  Possibly truncated (≥4990 chars): {desc_stats[4]} ({desc_stats[4]/desc_stats[0]*100:.2f}%)"
    )
    print(
        f"  Definitely truncated (=5000 chars): {desc_stats[5]} ({desc_stats[5]/desc_stats[0]*100:.2f}%)"
    )
    ...
    if feat_stats and feat_stats[0] > 0:
        ...
        print(
            f"  Possibly truncated (≥490 chars): {feat_stats[4]} ({feat_stats[4]/feat_stats[0]*100:.2f}%)"
        )
        print(
            f"  Definitely truncated (=500 chars): {feat_stats[5]} ({feat_stats[5]/feat_stats[0]*100:.2f}%)"
        )
    ...
    print(
        f"  Has featured artists: {metadata_stats[3]} ({metadata_stats[3]/total_videos*100:.1f}%)"
    )
    ...
    if conf_stats and conf_stats[0]:
        ...
        print(
            f"  Medium confidence (0.5-0.8): {conf_stats[4]} ({conf_stats[4]/total_videos*100:.1f}%)"
        )
