...
def detailed_analysis():
    ...
    columns_to_check = [
        'description', 'artist', 'song_title', 'featured_artists', 
        'genre', 'thumbnail_url', 'upload_date'
    ]
    ...
    for col in columns_to_check:
        ...
        print(f"{col:20} - Null: {null_c:3} ({null_c/total*100:5.1f}%), "
    ...
    print(f"Engagement ratio - Count: {er_count}, Min: {er_min:.2f}, Max: {er_max:.2f}, Avg: {er_avg:.2f}")
    ...
    print("-" * 50)
    tables = ['videos', 'channels', 'musicbrainz_data', 'discogs_data', 'quality_scores', 
              'ryd_data', 'video_features', 'validation_results']
